...
export default function ShootPicScreen({ navigation, route }: Props) {
  ...
  const handleCapture = async () => {
    ...
    try {
      ...
      const coords = location ? formatCoord(location.lat, location.lon)
...
const styles = StyleSheet.create({
  ...
  hint: { fontSize: 14, color: C.lightGray, textAlign: 'center', paddingHorizontal: 40 },
  ...
  shutterButton: {
    ...
    shadowColor: '#fff', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 6,
  },
