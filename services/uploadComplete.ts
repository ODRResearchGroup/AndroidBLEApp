...
export type UploadCompleteResponse = { ok: boolean; recordingId: string; kickedOff: boolean };
...
export async function notifyUploadComplete(
  ...
  if (!baseUrl || !functionKey) { throw new Error('Missing AZURE_FUNCTION_BASE_URL or AZURE_UPLOAD_COMPLETE_KEY'); }
